...
const Movies = () => {
  ...
  <div className='flex flex-col items-center justify-center h-[70vh] md:h-screen px-4'>
    <h1 className='text-xl md:text-3xl font-bold text-center'>No Movies Available</h1>
  </div>
